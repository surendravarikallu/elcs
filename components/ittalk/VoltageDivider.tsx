      ...
      <div className="border border-accent/20 bg-card/65 rounded-sm">
        <details className="group">
          ...
          <div className="p-6 border-t border-foreground/10 font-body text-xs text-foreground/70 space-y-6 leading-relaxed">
            <div>
              <h4 className="font-mono text-accent text-[11px] uppercase tracking-wider mb-2">What is a Voltage Divider?</h4>
              <p>
            ...
            <div>
              <h4 className="font-mono text-accent text-[11px] uppercase tracking-wider mb-2">It is commonly used in:</h4>
              <ol className="list-decimal pl-4 space-y-1">
                <li>Signal level reduction</li>
                <li>ADC input scaling (microcontrollers)</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-4 space-y-1">
                <li>In a voltage divider, the same current flows through both resistors because they are in series.</li>
                <li>The voltage drop across each resistor depends on its resistance value.</li>
                <li>Higher resistance &gt; higher voltage drop</li>
                <li>Lower resistance &gt; lower voltage drop</li>
                <li>By choosing proper resistor values, we can get the desired output voltage.</li>
              </ul>
            </div>
            <div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-foreground/10 text-left text-xs">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-foreground/10">
                      <td className="p-2 border-r border-foreground/10 font-mono">Vout</td>
                      <td className="p-2">Output Voltage (V)</td>
                    </tr>
                    <tr className="border-b border-foreground/10">
                      <td className="p-2 border-r border-foreground/10 font-mono">R1, R2</td>
                      <td className="p-2">Resistor values (Ω)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div>
              ...
              <p>Calculate Vout from Vin, R1, R2 | Calculate Vin from Vout, R1, R2 | Calculate R1 from Vin, Vout, R2 | Calculate R2 from Vin, Vout, R1 | Real-time calculation</p>
            </div>
            <div>
                ...
                <table className="w-full border-collapse border border-foreground/10 text-left text-xs">
                  <tbody>
                    <tr className="border-b border-foreground/10">
                      ...
                      <td className="p-2">Vout = Vin × (R2 / (R1 + R2))</td>
                    </tr>
                    <tr className="border-b border-foreground/10">
                      <td className="p-2 border-r border-foreground/10 font-mono text-accent">Inputs</td>
                      <td className="p-2">Vin, R1, R2, Vout</td>
                    </tr>
                    <tr className="border-b border-foreground/10">
                      <td className="p-2 border-r border-foreground/10 font-mono text-accent">Output</td>
                      <td className="p-2">Unknown value</td>
                    </tr>
                    <tr className="border-b border-foreground/10">
                      <td className="p-2 border-r border-foreground/10 font-mono text-accent">Precision</td>
                      <td className="p-2">Up to 6 decimal places</td>
                    </tr>
                    <tr className="border-b border-foreground/10">
                      <td className="p-2 border-r border-foreground/10 font-mono text-accent">Units</td>
                      <td className="p-2">Volts, Ohms</td>
                    </tr>
                  </tbody>
                </table>
              </div>
